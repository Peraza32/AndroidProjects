...
class ScoreActivity : AppCompatActivity() {
    ...
    private fun bind() {
        scoreTeamATextView = findViewById(R.id.status_team_a_text_view)
        scoreTeamBTextView = findViewById(R.id.status_team_b_text_view)
        statusTeamA = findViewById(R.id.status_team_a)
        statusTeamB = findViewById(R.id.status_team_b)
    }
